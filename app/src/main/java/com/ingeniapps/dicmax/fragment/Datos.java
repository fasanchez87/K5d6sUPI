...
import com.ingeniapps.dicmax.activity.WebViewVisor;
...
public class Datos extends Fragment
{
    ...
    public void onViewCreated(View view, Bundle savedInstanceState)
    {
        ...
        myWebView = (WebView) getActivity().findViewById(R.id.webViewDatos);
        ...
        progressDialog = new ProgressDialog(new android.support.v7.view.ContextThemeWrapper(Datos.this.getActivity(),R.style.AppCompatAlertDialogStyle));
        ...
        myWebView.setWebViewClient(new WebViewClient()
        {
            ...
            {
                final AlertDialog.Builder builder = new AlertDialog.Builder(Datos.this.getActivity());
        ...
        myWebView.loadUrl("https://kupi.com.co/");
