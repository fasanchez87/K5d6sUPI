package com.ingeniapps.dicmax.finger.dialog;
...
import com.ingeniapps.dicmax.finger.callback.FailAuthCounterCallback;
import com.ingeniapps.dicmax.finger.callback.FailAuthCounterDialogCallback;
...
import com.ingeniapps.dicmax.finger.callback.FingerprintDialogSecureCallback;
import com.ingeniapps.dicmax.finger.callback.FingerprintSecureCallback;
...
public class FingerprintDialog extends AnimatedDialog<FingerprintDialog> {
    ...
    public static boolean isEnrollFinger(Context context){
        FingerprintManager manager = (FingerprintManager) context.getSystemService(Context.FINGERPRINT_SERVICE);
