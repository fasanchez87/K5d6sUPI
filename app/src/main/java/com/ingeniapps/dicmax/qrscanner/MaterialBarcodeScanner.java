package com.ingeniapps.dicmax.qrscanner;
...
public class MaterialBarcodeScanner {
    ...
    public void startScan(){
        ...
        if(mMaterialBarcodeScannerBuilder.getActivity() == null){
            throw new RuntimeException("No se puede iniciar el escaner: Activity reference lost (please rebuild the MaterialBarcodeScanner before calling startScan)");
        }
